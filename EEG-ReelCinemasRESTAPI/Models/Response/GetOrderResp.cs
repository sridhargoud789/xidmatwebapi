...
namespace EEG_ReelCinemasRESTAPI.Models.Response.GetOrder
{
    ...
    public class Session
    {
        ...
        public EEG_ReelCinemasRESTAPI.Models.Response.Offer.Ticket[] Tickets { get; set; }
    }
}

namespace EEG_ReelCinemasRESTAPI.Models.Response.Offer
{
    public class Ticket
    {
