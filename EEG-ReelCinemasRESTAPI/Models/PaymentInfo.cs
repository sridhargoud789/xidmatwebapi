...
namespace EEG_ReelCinemasRESTAPI.Models.CompleteOrderByUBELoyalty
{
...
namespace EEG_ReelCinemasRESTAPI.Models.CompleteOrderByCard
{
    public class PaymentInfo
    {
        public string CardNumber { get; set; }
...
namespace EEG_ReelCinemasRESTAPI.Models.CompleteOrderByGiftCard
{
    public class PaymentInfo
    {
        public string CardNumber { get; set; }
